...
export function AdminDrawer({
  ...
  return (
    <>
      ...
      {open &&
        createPortal(
          // Renderizado direto no <body> (portal) — um <div z-40> preso dentro
          // de outro elemento com z-index já criava um problema real: ficava
          // atrás de irmãos mais tarde no DOM com o mesmo z-index (o quadro de
          // números, o rodapé fixo). Portal evita esse problema de vez.
          <div className="fixed inset-0 z-[100] flex justify-end bg-black/50" onClick={() => setOpen(false)}>
            <div
            ...
            >
              ...
              {(onExportReportJson || onExportReportCsv) && (
